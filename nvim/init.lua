...
now(function()
	...
	add({ source = "folke/neodev.nvim", depends = { "neovim/nvim-lspconfig" } })
	add("mfussenegger/nvim-dap")
	add({ source = "rcarriga/nvim-dap-ui", depends = { "mfussenegger/nvim-dap", "folke/neodev.nvim" } })
	add({
		source = "L3MON4D3/LuaSnip",
		depends = { "rafamadriz/friendly-snippets", "honza/vim-snippets" },
	})
	add({
	...
	add({
		...
		depends = { "nvim-treesitter/nvim-treesitter", "L3MON4D3/LuaSnip" },
	})
	...
	add({ source = "rest-nvim/rest.nvim", depends = { "nvim-lua/plenary.nvim", "nvim-treesitter/nvim-treesitter" } })
	...
	add({ source = "hrsh7th/nvim-cmp", depends = { "L3MON4D3/LuaSnip" } })
	add({
	...
	add({
		...
		depends = { "hrsh7th/nvim-cmp", "neovim/nvim-lspconfig" },
	})
	add({
		source = "saadparwaiz1/cmp_luasnip",
		depends = { "hrsh7th/nvim-cmp", "L3MON4D3/LuaSnip" },
	})
	add({
		source = "petertriho/cmp-git",
		depends = { "hrsh7th/nvim-cmp", "nvim-lua/plenary.nvim" },
	})
	add({
...
now(function()
	...
	nmap("<leader>eC", "<cmd>require('nvim-tree.api').tree.collapse_all(true)<cr>", "Tree collapse")
	nmap("<leader>ec", "<cmd>require('nvim-tree.api').tree.collapse_all(false)<cr>", "Tree collapse")
	nmap("<leader>ef", "<cmd>lua if not MiniFiles.close() then MiniFiles.open() end<cr>", "Toggle file explorer")
	nmap("<leader>ef", "<cmd>require('nvim-tree.api').tree.find_file()<cr>", "Find tree file")
	nmap("<leader>er", "<cmd>require('nvim-tree.api').tree.refresh()<cr>", "Tree refresh")
	nmap("<leader>et", "<cmd>require('nvim-tree.api').tree.toggle()<cr>", "Toggle tree")
	...
	nmap("<leader>xx", "<cmd>lua require('trouble').toggle()<cr>", "Toggle trouble")
