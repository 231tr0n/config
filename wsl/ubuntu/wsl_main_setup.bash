...
sudo apt install -y git curl wget inxi openssl ssh man-db htop jq vim tmux tmate ca-certificates libssl-dev libssh-dev libgit2-dev libcurl4-openssl-dev pkgconf nala software-properties-common fuse
